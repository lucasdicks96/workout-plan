...
export interface WorkoutSessionExercise {
  ...
  sets: WorkoutSet[]; // Die Liste der tatsächlich ausgeführten Sätze mit Wiederholungen
}
...
export interface WorkoutSession {
  ...
  exercises: WorkoutSessionExercise[]; // Liste der Übungen mit den erfassten Sätzen
